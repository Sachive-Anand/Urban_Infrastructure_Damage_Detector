      ...
      <header style={css.header}>
        <div style={css.headerInner}>
          <div style={css.logo}>
            ...
            <div>
              ...
              <div style={css.logoSub}>
                Urban Infrastructure Damage Detector
              </div>
            </div>
          </div>
          <div style={css.headerBadges}>
            ...
            <div style={{ ...css.badge, color: "var(--muted2)" }}>☁ AWS S3</div>
          </div>
        </div>
      </header>
        ...
        <aside style={css.sidebar}>
          ...
          {result && (
            ...
            >
              {removing ? (
                <>
                  <span style={{ ...css.spin, borderTopColor: "#fff" }} />
                  Removing...
                </>
              ) : (
                <>🗑 Remove & Re-upload</>
          ...
          {file && !result && !loading && (
            <button style={css.clearBtn} onClick={reset}>
              ✕ Clear
            </button>
          )}
          ...
          {result && (
            <div style={css.scanInfo}>
              ...
              <div style={css.scanInfoRow}>
                ...
                <span style={{ ...css.scanInfoValue, color: "#22c55e" }}>
                  ☁ Saved to S3
                </span>
              </div>
              <div style={css.scanInfoRow}>
            ...
            <div style={css.imageBox}>
              ...
              {loading && (
                <div style={css.loadOverlay}>
                  <div style={css.loadBox}>
                    ...
                    <div style={css.loadSub}>
                      YOLOv8 scanning · Saving to S3...
                    </div>
              ...
              {!preview && !loading && (
                <div style={css.emptyState}>
                  ...
                  <div style={css.emptySub}>
                    Upload a road photo to begin detection
                  </div>
                </div>
              )}
            </div>
            ...
            <div style={{ ...css.detCard, animation: "fadeUp 0.5s ease" }}>
              ...
              {result.total_detections === 0 ? (
                <div style={css.noDetect}>
                  ...
                  <span>
                    No road damage detected at {conf}% confidence threshold.
                  </span>
                </div>
              ) : (
                <>
                      ...
                      return (
                        <div key={i} style={css.detRow}>
                          ...
                          <div style={css.detRowRight}>
                            ...
                            >
                              <span
                                style={{ ...css.sevDot, background: sc.dot }}
                              />
                              {d.severity}
                            </span>
...
const css = {
  ...
  scanline: {
    ...
    height: "30%",
    background:
      "linear-gradient(transparent, rgba(0,229,255,0.015), transparent)",
    pointerEvents: "none",
    zIndex: 0,
  ...
  layout: {
    ...
    padding: "24px 28px",
    display: "grid",
    gridTemplateColumns: "clamp(260px, 25%, 320px) 1fr", // ← change this line
    gap: 24,
    flex: 1,
    position: "relative",
    zIndex: 1,
